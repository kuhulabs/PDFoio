export const TOOL_SEO = {
  ...
  "png-to-pdf": {
    ...
    metaDescription:
      "Apni PNG images ko bina quality khoye PDF mein badlein. Transparency support aur batch conversion ke saath multiple PNGs ko ek hi document mein merge karein. Fast aur secure.",
    shortIntro:
      "Apni PNG photos aur designs ko ek high-quality professional PDF document mein badlein.",
    intro:
      "PNG format apni lossless quality aur transparency ke liye jaana jata hai. Kuhu Labs ka 'PNG to PDF' converter ye ensure karta hai ki aapke designs, logos ya screenshots ki clarity PDF banne ke baad bhi barkarar rahe. Aap multiple PNG files ko ek saath upload karke unka order change kar sakte hain aur unhe ek hi organized PDF file mein save kar sakte hain.",
    howItWorks: [
      "Apni PNG images upload karein.",
      "Zarurat ke hisaab se images ko reorder karein (drag and drop).",
      "Page orientation aur margins set karein.",
      "‘Convert’ button par click karein aur apni PDF download karein.",
    ],
    benefits: [
      "Lossless Conversion: PNG ki original clarity aur pixels ko save rakhta hai",
      "Transparency Support: Transparent backgrounds ko cleanly handle karta hai",
      "Batch Processing: Ek saath kayi images ko ek hi PDF mein merge karein",
      "Fast & Private: Browser-based conversion jo 100% secure hai",
    ],
    faqs: [
      {
        question: "Kya PNG to PDF conversion free hai?",
        answer:
          "Ji haan, PDFo par aap jitni chahein utni PNG images ko bilkul free mein PDF mein convert kar sakte hain.",
      },
      {
        question:
          "Kya mere transparent PNG images ka background kharab ho jayega?",
        answer:
          "Nahi, hamara tool transparency ko support karta hai. PDF mein wo background clean aur professional dikhega.",
      },
      {
        question: "Ek saath kitni PNG images upload kar sakte hain?",
        answer:
          "Aap ek saath multiple images upload karke unhe ek hi document mein bundle kar sakte hain. Ye portfolio banane ke liye best hai.",
      },
    ],
    relatedTools: [
      { name: "Images to PDF", path: "/images-to-pdf" },
  ...
  "images-to-pdf": {
    ...
    metaDescription:
      "Apni JPG, PNG, aur baaki images ko ek hi PDF document mein convert karein. Fast, free aur 100% secure image to PDF converter. Kisi bhi device se use karein.",
    shortIntro:
      "Dher saari photos ko ek hi professional PDF mein badlein, wo bhi bina quality khoye.",
    intro:
      "Kuhu Labs ka 'Images to PDF' tool sabhi major formats jaise JPG, PNG, TIFF, aur BMP ko support karta hai. Chahe aapko apne college ke notes ki photos ko ek assignment banana ho ya scanned receipts ko ek report mein convert karna ho, hamara tool ye kaam seconds mein kar deta hai. Ye mobile-friendly hai, isliye aap apne phone se directly photos select karke PDF bana sakte hain.",
    howItWorks: [
      "Apni images (JPG, PNG, etc.) upload karein.",
      "Thumbnails ko drag karke sahi sequence mein set karein.",
      "Page size, orientation (Portrait/Landscape) aur margin adjust karein.",
      "‘Convert to PDF’ par click karein aur apni file download karein.",
    ],
    benefits: [
      "Multi-format support: Ek saath JPG aur PNG files ko combine karein",
      "Batch conversion: Unlimited images ko ek hi document mein merge karein",
      "Privacy first: Aapki files upload hone ke 1 ghante baad automatically delete ho jati hain",
      "High resolution: Images ki asli quality aur clarity barkarar rehti hai",
    ],
    faqs: [
      {
        question:
          "Kya main alag-alag format ki images ko ek hi PDF mein daal sakta hoon?",
        answer:
          "Ji haan! Aap JPG, PNG aur TIFF files ko ek saath upload karke unhe ek hi PDF document mein merge kar sakte hain.",
      },
      {
        question: "Kya conversion ke बाद images ki quality kam ho jayegi?",
        answer:
          "Bilkul nahi. Hamara advanced engine images ko pixel-perfect rakhta hai taaki aapka PDF professional aur saaf dikhe.",
      },
      {
        question: "Mobile se photos ko PDF kaise banayein?",
        answer:
          "Bas apne phone ke browser mein PDFo open karein, gallery se photos select karein aur convert button dabaein. Ye process bahut hi fast aur easy hai.",
      },
    ],
    relatedTools: [
  ...
  summarize: {
    ...
    relatedTools: [{ name: "PDF to TXT", path: "/pdf-to-txt" }],
  },
};
