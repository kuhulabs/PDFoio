...
export default function PDFToTIFF() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const zipBlob = await convertPDFToTIFF(file); // Note: Assuming logic handles compressionType internally or you need to pass it
      ...
      toast({
        title: "Success!",
        description: "PDF converted to TIFF images successfully.",
      });
    } catch (error) {
      console.error(error);
      toast({
            ...
            {!convertedFile ? (
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value: "none" | "lzw" | "jpeg") =>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="none">
                          None (Lossless, Larger Size)
                        </SelectItem>
                        <SelectItem value="lzw">
                          LZW (Lossless, Standard)
                        </SelectItem>
                    ...
                    <p className="text-xs text-muted-foreground">
                      LZW is recommended for most documents to maintain quality
                      while reducing size.
                    </p>
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full bg-amber-600 hover:bg-amber-700 text-white shadow-md h-12 text-lg"
                  >
                    {isProcessing ? (
                      <>
              ...
              <div className="max-w-2xl mx-auto bg-card border rounded-xl shadow-sm p-8 text-center animate-in zoom-in-95 duration-300">
                ...
                <p className="text-muted-foreground mb-8">
                  Your PDF pages have been converted to TIFF images.
                </p>
