  ...
  return (
    <>
      <SEOHead 
        ...
        canonicalUrl="https://pdfo.io/pdf-to-excel"
      />
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!file ? (
          ...
          <>
            {/* File Info Card */}
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-200 dark:border-green-700 rounded-lg p-4 mb-6">
              <div className="flex items-start justify-between">
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-100 mt-2">
                      <i className="fas fa-file-excel mr-1"></i>Ready to Convert
                    </span>
                  </div>
                </div>
