...
export default function ReorderPages() {
  const seoData = TOOL_SEO['reorder'] || { title: 'Reorder Pages', h1: 'Reorder Pages', shortIntro: 'Reorder your PDF pages.', metaDescription: '', keywords: '' };
  ...
  return (
    <>
      <SEOHead breadcrumbs={[{ name: "Home", url: window.location.origin }, { name: "Reorder Pages", url: `${window.location.origin}/reorder` }]}  
        title={seoData.title}
