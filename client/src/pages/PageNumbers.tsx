...
export default function PageNumbers() {
  ...
  const handleAddPageNumbers = async (settings: PageNumberSettings) => {
    ...
    try {
      ...
      await trackToolUsage("Page Numbers", "manipulation", 1);
  ...
  return (
    <>
      <SEOHead breadcrumbs={[{ name: "Home", url: window.location.origin }, { name: "Page Numbers", url: `${window.location.origin}/page-numbers` }]}  
        title={seoData.title}
        description={seoData.metaDescription}
        keywords="page numbers, add page numbers to pdf, number pdf pages"
